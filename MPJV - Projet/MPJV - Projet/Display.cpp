...
void Display::drawCube(glm::vec3 position, glm::vec3 rotation, glm::vec3 scale, Shader shader)
{
	int width, height;
	...
	glm::mat4 projection = glm::perspective(glm::radians(getCamera()->Zoom), (float)width / (float)height, 0.1f, 100.0f);
